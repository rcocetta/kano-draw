...
module.exports = function (steps, synonyms)  {
    ...
    /**
     * Simply validates a string against a regex.
     * @param {string} regex a regex in string form
     * @param {string} str a string
     * @return {boolean} true if the string matches the regex
     */
    ...
    /**
     * Validates a single line against a single rule
     * @param {object/string} rule A validation rule
     * @param {string} line A line of code
     * @return {boolean} true if the line validates on the rule, false otherwise
    */
        ...
        validate: function (code) {
            ...
            steps.forEach(function (step, stepIdx) {
                ...
                for (i = 0; i < currLines.length; i++) {
                    //TODO: this could possibly be cleaner
